export const GENRES = JSON.parse('{"genres":[{"id":28,"name":"Action"},{"id":12,"name":"Adventure"},' +
    '{"id":16,"name":"Animation"},{"id":35,"name":"Comedy"},{"id":80,"name":"Crime"},{"id":99,"name":"Documentary"},' +
    ...
    '{"id":10752,"name":"War"},{"id":37,"name":"Western"}]}').genres;
